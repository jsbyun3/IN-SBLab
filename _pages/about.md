...
<div style="display: flex; align-items: center; justify-content: flex-start; gap: 40px; margin-bottom: 30px; white-space: nowrap;">
  <img src="{{ '/assets/img/kmu_type30.png' | relative_url }}" style="width: 150px; height: auto; flex-shrink: 0;" alt="kmu logo">
  
  <div style="font-size: 0.95rem; line-height: 1.4; border-right: 1px solid #eee; padding-right: 20px; flex-shrink: 0;">
    <a href="https://bioscience.kmu.ac.kr/">Department of Biological Sciences</a> |<br>
    <a href="https://www.kmu.ac.kr/">Keimyung University</a>
  </div>

  <details style="cursor: pointer; position: relative; flex-shrink: 0;">
    <summary style="list-style: none; font-weight: bold; display: flex; align-items: center; gap: 5px;">
      <span>▶ ⚙️ Site Map</span>
    </summary>
    <ul style="position: absolute; top: 30px; left: 0; background: white; border: 1px solid #ddd; padding: 10px 15px; list-style: none; z-index: 999; box-shadow: 0 4px 10px rgba(0,0,0,0.1); line-height: 1.8; border-radius: 4px;">
  ...
  <div style="color: #888; font-size: 0.85rem; margin-left: auto; flex-shrink: 0;">
